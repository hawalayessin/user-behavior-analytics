    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          { label: "Successful Payments",     value: revenue.billing_success.toLocaleString(),   color: "text-emerald-400" },
          { label: "Failed Payments",     value: revenue.billing_failed.toLocaleString(),    color: "text-red-400"     },
        ].map((kpi) => (
