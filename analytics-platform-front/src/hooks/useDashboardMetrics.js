...
export function useDashboardMetrics(data) {
  return useMemo(() => {
    ...
    const subscriptionPieData = [
      ...
      { name: "Essai",   value: subscriptions.trial     ?? 0, fill: "#6366F1" },
      { name: "Expirés", value: subscriptions.expired   ?? 0, fill: "#F59E0B" },
    ...
    const engagementBars = [
      ...
      },
      {
        ...
        value:    safePercent(subscriptions.trial, subscriptions.total),
        target:   null,
        sublabel: `${subscriptions.trial ?? 0} utilisateurs en période d'essai`,
        color:    "#6366F1",
      },
      {
