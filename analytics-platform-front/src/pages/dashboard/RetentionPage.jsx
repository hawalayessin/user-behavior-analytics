...
export default function RetentionPage() {
  ...
  const exportExcel = async () => {
    ...
    XLSX.writeFile(
      wb,
      `cohorts_retention_${new Date().toISOString().split("T")[0]}.xlsx`,
    );
              ...
              : kpis && (
                  <>
                    ...
                    <KPICard
                      ...
                      trendLabel={
                        kpis.at_risk > 0 ? "need attention" : "healthy"
                      }
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {cohortsLoading ? (
                    ...
                    sortedCohorts.map((c) => {
                      const badge =
                        HEALTH_BADGE[c.health] ?? HEALTH_BADGE.critical;
                      return (
                        <tr
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <span
                              className={`inline-block px-3 py-1 rounded text-xs font-medium border capitalize ${badge}`}
                            >
                              {c.health}
                            </span>
                          </td>
